...
Notes for Slide: A short discussion on why we introduced competitions and the types of problems they've solved.
...
+ Links to example modeling competitions we've run on Kaggle before.